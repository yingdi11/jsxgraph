...
define([
    ...
    JXG.Board = function (container, renderer, id, origin, zoomX, zoomY, unitX, unitY, canvasWidth, canvasHeight, attributes) {
         ...
         * @type Number
         * @property BOARD_MODE_MOVE_ORIGIN
         * @final
         */
         ...
         * @type Boolean
         * @default false
         * @property geonextCompatibilityMode
    ...
    JXG.extend(JXG.Board.prototype, /** @lends JXG.Board.prototype */ {
         ...
         * @method addPointerEventHandlers
         */
         ...
         * @method removePointerEventHandlers
         */
         ...
         * @method removeMouseEventHandlers
         */
